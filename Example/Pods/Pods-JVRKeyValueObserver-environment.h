...
// JVRKeyValueObserver
#define COCOAPODS_POD_AVAILABLE_JVRKeyValueObserver
#define COCOAPODS_VERSION_MAJOR_JVRKeyValueObserver 0
#define COCOAPODS_VERSION_MINOR_JVRKeyValueObserver 1
#define COCOAPODS_VERSION_PATCH_JVRKeyValueObserver 0
